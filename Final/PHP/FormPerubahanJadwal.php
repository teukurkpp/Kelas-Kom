            ...
            <form id="kelasForm" method="POST" action="ProsesPerubahanJadwal.php">
                ...
                <div class="mb-3">
                    ...
                    <select id="kelas" name="kelas" class="form-select" required>
                        ...
                        <?php
                        $query_kelas = mysqli_query($conn, "SELECT DISTINCT kelas FROM jadwal_matkul ORDER BY kelas");
                ...
                <div class="d-flex gap-2 mt-4">
                    <!-- Gantilah tombol submit agar tidak disabled -->
                    <?php if ($status === 'kosong'): ?>
                        <button type="submit" id="btnSementara" class="btn btn-success w-50">Ubah Sementara</button>
                        <button type="submit" id="btnPermanen" class="btn btn-danger w-50">Ubah Permanen</button>
                    <?php else: ?>
                        <button type="submit" id="btnSementara" class="btn btn-success w-100">Ubah Sementara</button>
                    <?php endif; ?>
